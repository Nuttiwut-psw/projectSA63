...
func (e PatientEdges) PatientIDOrErr() ([]*Booking, error) {
	if e.loadedTypes[0] {
...
// QueryPatientID queries the patient_id edge of the Patient.
func (pa *Patient) QueryPatientID() *BookingQuery {
	return (&PatientClient{config: pa.config}).QueryPatientID(pa)
}
