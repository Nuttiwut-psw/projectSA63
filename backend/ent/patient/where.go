...
func HasPatientID() predicate.Patient {
	return predicate.Patient(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(PatientIDTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, PatientIDTable, PatientIDColumn),
		)
...
func HasPatientIDWith(preds ...predicate.Booking) predicate.Patient {
	return predicate.Patient(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
