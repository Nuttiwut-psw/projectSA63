...
func (e UserEdges) DoctorIDOrErr() ([]*Booking, error) {
	if e.loadedTypes[0] {
...
// QueryDoctorID queries the doctor_id edge of the User.
func (u *User) QueryDoctorID() *BookingQuery {
	return (&UserClient{config: u.config}).QueryDoctorID(u)
}
